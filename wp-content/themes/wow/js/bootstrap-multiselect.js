...
!function($) {
    ...
    function Multiselect(select, options) {
        ...
        if (this.options.placeholder == 'by-data')
            this.options.placeholder = this.$select.data('placeholder');

        if (this.options.nonSelectedText == 'by-data')
            this.options.nonSelectedText = this.$select.data('non-select');
    ...
    Multiselect.prototype = {
        ...
        buildButton: function() {
            ...
            // Adopt active state.
            if (this.$select.prop('disabled') || this.$select.attr('disabled') !== undefined) {
                this.disable();
            }
            else {
                this.enable();
